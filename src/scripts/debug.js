...
var debug = [
	{
		...
		'[[Advance Day|Debug - Menu][$time.currentDayTime = 4]]','[[Advance Time|Debug - Menu][$time.currentDayTime += 1]]','Get Cash: <<= setup.displayUnits($player)>> - [[Get Units|Debug - Menu][$player.units += 10000]]','Set Name: <<link "Press Me">><<SetName>><</link>>',
	...
	},
	{
		...
		'<span class="lbb"><<button "Pod - Reflection">><<goto "Pod - Reflection">>"<</button>></span>',
	...
	},
	{
		...
		'Oral, giving: [[Go Here|Sex][$sex.current = "blowjob", $sex.givingEntity = $player, $sex.receivingEntity = $npc.adults[0], $sex.stage = "intro", $sex.modifier = "sensual", $sex.passage = "Debug - Menu"]]',
		'Oral, receiving: [[Go Here|Sex][$sex.current = "blowjob", $sex.givingEntity = $npc.adults[0], $sex.receivingEntity = $player, $sex.stage = "intro", $sex.modifier = "sensual", $sex.passage = "Debug - Menu"]]',
